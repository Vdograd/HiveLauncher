...
class DialogError(QtWidgets.QDialog):
    def __init__(self, name: str, message: str, type_error: str):
        super().__init__()
        try: self.color = build.get_color_theme()
        except: self.color = 'light'
    ...
    def show_error(self):
        ...
        self.version_update_launcher.setText(f'HIVELAUNCHER  v{build.version_launcher}')
